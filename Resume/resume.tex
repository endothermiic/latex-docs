...
\begin{rSection}{EDUCATION}
   ...
   \begin{itemize}
    \itemsep -8pt {} 
     \item Relevant coursework: Computer organization, digital systems, software design
     \item Dean's Honour List (cGPA: 3.96/4.00)
...
\begin{rSection}{EXPERIENCE}
   ...
   \vspace{-0.2cm}
    \begin{itemize}
       ...
       \item Created custom IPs, modified pre-existing test-bench suites (Verilog) and worked with oscilliscopes to test incoming ASICs for functionality
